  ...
  return (
    <>
        <div className="flex items-center justify-center w-full">
            <div className="relative w-full h-[597px] mt-50 max-md:mt-750 md:mt-260 2xl:mt-40 xl:mt-40 lg:mt-40">
                <div className="relative h-full w-full flex justify-center items-center xl:w-[40vw] md:w-[95vw]">
                    <h1 className={`absolute left-10 top-35 text-black text-[48px] ${interFont.className} max-md:max-w-[500px] max-sm:text-[30px] max-sm:text-nowrap max-md:left-5 md:text-nowrap md:text-[30px]`}>
                        Everyone can be a <br /> chef in their own kitchen
                    </h1>
                    <p className={`absolute left-0 right-0 top-[90px] text-[1rem] sm:left-20 max-sm:text-[14px] max-md:top-80 lg:left-6 lg:max-w-[400px] max-sm:max-w-[400px] max-sm:top-70 xl:top-75 w-full break-words`}>
                    ...
                    <button className={`absolute bottom-15 bg-black pt-[18px] pb-[18px] pl-[55px] pr-[55px] left-10 rounded-2xl text-white flex hover:cursor-pointer text-nowrap`}>
                        Learn More
                    </button>
                </div>
