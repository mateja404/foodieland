  ...
  return (
    <>
        <div className="flex items-center justify-center w-full overflow-x-hidden">
            <div className="relative w-full h-[597px] mt-50 max-md:mt-750 md:mt-260 2xl:mt-40 xl:mt-40 lg:mt-40 max-sm:h-[550px] 2xl:h-[597px] bg-white  xl:bg-white 2xl:bg-white">
                <div className="relative h-full w-full flex justify-center items-center xl:w-[40vw] md:w-[95vw]">
                    <h1 className={`absolute left-10 top-35 text-black text-[48px] ${interFont.className} max-md:max-w-[500px] max-sm:text-[30px] max-sm:text-nowrap max-md:left-5 md:text-nowrap md:text-[30px] xl:text-[55px] 2xl:text-[68px]`}>
                ...
                <div className="absolute top-0 right-0 h-full w-full flex max-md:hidden xl:w-[50vw]">
                    <div className="relative w-full flex justify-center items-center bg-gradient-to-t from-blue-300/30 rounded-[20px] md:flex lg:flex xl:flex 2xl:flex">
                        <Image src={chief} alt="chief" className="absolute bottom-0 md:right-0 2xl:w-[650px] 2xl:h-[600px]" width={500} height={500}/>
                        <Image src={vegan} alt="vegan" className="absolute top-30 right-5 md:hidden lg:top-105 lg:right-2 xl:flex 2xl:flex" />
                        <Image src={meat} alt="meat" className="absolute left-37 md:hidden lg:left-10 xl:flex xl:left-50 xl:top-45 2xl:flex 2xl:left-50 2xl:top-30" />
                        <Image src={tomato} alt="tomato" className="absolute bottom-30 -left-5 md:hidden xl:flex 2xl:flex" />
                        <Image src={onion} alt="onion" className="absolute right-55 top-20 md:hidden 2xl:flex 2xl:top-30 2xl:right-5 xl:flex xl:right-30 xl:top-10 lg:right-10 lg:top-10" />
                    </div>
                </div>
            </div>
        </div>
