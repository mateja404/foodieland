  ...
  return (
    <>
        <div className='flex align-center justify-center w-full overflow-x-hidden mt-40'>
            <div className='relative w-full h-[964px] bg-gradient-to-t from-blue-300/30 via-blue-400/30 text-center'>
                ...
                <div className='grid grid-cols-4 place-items-center mt-25'>
