  ...
  return (
    <div className='flex align-center justify-center'>
        <div className='bg-[#E6F9FD] w-[80vw] h-[75vh] mt-10 rounded-[50px] relative max-md:w-full md:w-[95vw]'>
            ...
            <h1 className='absolute left-20 top-35 text-[64px] font-bold max-md:text-[47px] max-sm:left-10 lg:left-6 lg:text-[50px]'>Spicy delicious <br/> chicken wings</h1>
            <p className='absolute left-20 top-90 text-[1rem] max-sm:left-10 max-md:top-80 lg:left-6 lg:max-w-[400px]'>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod <br/> tempor incididunt ut labore et dolore magna aliqut enim ad minim </p>
            <div className='absolute left-20 top-110 pt-[10px] pb-[10px] pl-[30px] pr-[30px] bg-[#DBEEF1] rounded-[50px] max-md:top-111 max-md:left-10 lg:left-6 lg:top-120'>
                <span className={`flex ${interFont.className} text-[14px]`}><Timer className='translate-x-[-15px]' />30 Minutes</span>
            </div>
            <div className='absolute left-65 top-110 pt-[10px] pb-[10px] pl-[30px] pr-[30px] bg-[#DBEEF1] rounded-[50px] max-md:top-111 max-md:left-55 lg:left-50 lg:top-120'>
                <span className={`flex ${interFont.className} text-[14px]`}><Utensils className='translate-x-[-15px]' />Chicken</span>
            </div>
            <Image className='absolute left-20 bottom-15 max-md:left-7 max-md:top-135 lg:left-7' src={heroavatar} alt='heroavatar'/>
            <h1 className={`absolute left-37 bottom-20 font-extrabold ${interFont.className} text-black max-md:left-23 max-md:top-135 lg:left-23`}>John Smith</h1>
            <p className='absolute left-37 bottom-14 text-[#5C6466] font-semibold max-md:left-23 max-md:top-142 lg:left-23'>15 March 2022</p>
            <button className='absolute bottom-15 bg-black pt-[18px] pb-[18px] pl-[55px] pr-[55px] left-100 rounded-2xl text-white flex hover:cursor-pointer max-md:left-100 max-md:bottom-26 max-sm:left-7 max-sm:bottom-5 max-md:pl-[25px] max-md:pr-[25px] md:left-110 lg:left-70 lg:bottom-13 lg:pl-[25px] lg:pr-[25px]'>View Recipes <Image src={playbtn} alt='playbtn' className='translate-x-[10px] translate-y-[2px] w-[20px] h-[20px]' /></button>
