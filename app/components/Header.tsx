    ...
    <>
        <header className='w-full h-[100px] bg-white border-b border-[#E4E6F1] relative left-0 flex flex-row align-center justify-center'>
            ...
            <ul className='inline-flex gap-12 absolute top-8 max-md:hidden md:top-10'>
                ...
                <li className={`${interFont.className}`}><Link href="#" className='text-[1rem]'>Blog</Link></li>
                <li className={`${interFont.className}`}><Link href="#" className='text-[1rem]'>Contact</Link></li>
                <li className={`${interFont.className}`}><Link href="#" className='text-[1rem]'>About us</Link></li>
            </ul>
