    ...
    <>
      <div className='flex align-center justify-center mt-80 max-md:mt-570 md:mt-240 lg:mt-140 xl:mt-70'>
        <div className='relative w-[1280px] h-[442px] bg-[#E7F9FD] rounded-[50px] text-center'>
          ...
          <p className={`absolute top-45 left-1/2 translate-x-[-50%] ${interFont.className} max-md:top-40`}>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </p>
          <Image src={inboxsalad} alt='inboxsalad' className='absolute bottom-0 left-0 max-md:w-[200px] max-md:h-[200px] md:w-[250px] md:h-[250px] xl:w-[320px] xl:h-[320px]' />
          <Image src={inboxsaladright} alt='inboxsaladright' className='absolute bottom-0 right-0 max-md:w-[120px] max-md:h-[120px] md:w-[180px] md:h-[180px] xl:w-[220px] xl:h-[220px]' />
          <Image src={trava} alt='trava' className='absolute bottom-20 right-60 max-md:hidden md:hidden' />
          <div className='flex flex-row absolute bottom-10 left-1/2 -translate-x-1/2 w-fit max-md:bottom-20 md:bottom-20 z-10'>
